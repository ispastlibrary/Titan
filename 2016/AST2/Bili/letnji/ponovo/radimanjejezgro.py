...
def izlazni(V,av): #izlazni intenzitet normiran tako da je I0=1, a funkcija izvora S=1/2
...
plt.plot(EW1,T1)
plt.suptitle('Zavisnost ekvivalentne sirine od temperature komete')
...
#plt.xlim(0,0.2e+7)
plt.suptitle("Haserov model za različite temperature")
plt.xlabel("Rastojanje od jezgra [m]")
