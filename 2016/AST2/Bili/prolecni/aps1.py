...
me=9.1e-31  #masa elektrona
T=400  #temperatura u perihelu (uzeta kao za Haleja) [K]
Rmerkur=1 #poluprecnik kome kada je najveca [m]   
rmerkur=1e-10 # gustina kome [kg/m^3]   
...
#    smena=pow(2*np.pi*me*k*T/(h*h),3/2)*np.exp(-Ejon/(k*T))
#    ZI=part_funk(a,T)
#    ZII=part_funk(b,T)	
